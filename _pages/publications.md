...
<div class="publication-card-grid">
  <article class="publication-card">
    ...
    <p><strong>Contribution note:</strong> Participated in neuromorphic-computing workflow support, data processing, and reproducible analysis around memristor-based learning tasks.</p>
  ...
  <article class="publication-card">
    ...
    <p><strong>Contribution note:</strong> Contributed to text/speech data preprocessing, MATLAB-based training workflow, code debugging, and result visualization for multimodal reservoir-computing tasks.</p>
...
<div class="publication-card-grid">
  <article class="publication-card">
    ...
    <p>An AI-assisted ~300,000-character technical note on PCSEL electromagnetic theory, numerical methods, epitaxy, quantum-well gain, and electro-thermal-optical device modeling.</p>
...
<p>
  Public-ready artifacts are listed on the <a href="{{ '/projects/' | relative_url }}">Projects</a> page. Internal solver runs, RLcode outputs, and PCSEL paper-library entries are being sanitized before public release.
</p>
</section>
